...
import { Box, useColorModeValue, Heading, Slider, SliderTrack, SliderFilledTrack, SliderThumb, Text } from '@chakra-ui/react'

import { AddIcon, MinusIcon, ArrowRightIcon, ArrowLeftIcon } from '@chakra-ui/icons'
    ...
    <Layout>
      <Box height="100%" width={'100%'} display={'flex'} justifyContent={'center'} alignItems={'center'}>
        <Box
          ...
          margin={10}
          height={'80%'}>
          <ArrowLeftIcon color="pink" boxSize={7} onClick={() => router.push('/app/sybil-protection')} _hover={{ cursor: 'pointer' }} />
          <Box
            position="relative"
            width={'100%'}
            display="flex"
